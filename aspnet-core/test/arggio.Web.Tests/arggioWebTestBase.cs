...
{
    public abstract class arggioWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static arggioWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(arggioWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<arggioDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<arggioDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<arggioDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<arggioDbContext, Task<T>> func)
        {
            T result;
