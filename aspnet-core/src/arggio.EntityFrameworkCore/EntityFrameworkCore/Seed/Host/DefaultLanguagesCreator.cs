...
namespace arggio.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly arggioDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = arggioConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(arggioDbContext context)
        {
            _context = context;
        }
